...
class ArabicCharCNN(nn.Module):
    def __init__(self):
        ...
        # Convolutional layers with increasing feature maps
        ...
        self.fc4 = nn.Linear(in_features=512, out_features=28)  # 29 classes for Arabic characters 

        # Dropout
        self.dropout = nn.Dropout(p=0.8)

    def forward(self, x):
        # Apply convolutional layers, batch normalization, ReLU activation and pooling
